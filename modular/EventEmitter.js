...
EventEmitter.prototype.emit = function (type) {
    ...
    if (typeof handler === 'function') {
        ...
        listeners = handler.slice().sort(function (previous, next) {
...
EventEmitter.prototype.addListener = function (type, listener, priority) {
    var m;
    priority = priority || 0;
    ...
    if (!this._events)
        this._events = {};
    listener.priority = listener.priority || priority
